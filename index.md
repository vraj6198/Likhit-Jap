...
This policy explains what data the app handles, when (and why) any of it leaves your device, and
...
- The deity/name and target count for each sankalpa you create, and how many repetitions you've
  completed
- The coordinates of any custom guide script you hand-draw (stored as a list of points, not an
  image)
- A log of your writing and mala "sittings" (repetitions, duration, and timestamp)
- Your preferences: language, script (Devanagari/Latin), writing mode, reminder toggles and times,
  daily goal, chant/haptic settings, and your last-used mala deity
...
To serve and measure these ads, Google may collect technical and usage information such as device
identifiers, IP address (and the coarse location derivable from it), ad interaction data, and
app/device information. This is governed by Google's own privacy policy:
...
The optional morning reminder and "gentle nudge" are **local, on-device notifications** scheduled
...
- No collection of your name, email, contacts, photos, microphone, or location
- No data brokers, no sale of data
- No sharing with third parties other than Google (for ad serving, as described above) and Apple
  (for payments and notifications, as part of iOS itself)

### Your controls

- **Delete a sankalpa:** remove any individual japa from the Active tab at any time
- **Turn off reminders:** Settings → Reminder (morning reminder and gentle nudge toggles)
...
If this policy changes materially, the "Last updated" date above will change to reflect it.
...
effects of any practice it helps you track.

### 2. Eligibility

The App is intended for a general audience. If you are under the age of majority in your
jurisdiction, you should use the App only with the involvement of a parent or guardian.

### 3. License to use the app

Subject to these Terms, we grant you a personal, non-exclusive, non-transferable, revocable
license to install and use the App on Apple devices you own or control, for your own personal,
non-commercial use — solely as permitted by Apple's Media Services Terms and Usage Rules and
applicable law. All rights not expressly granted are reserved.

### 4. Your content

Any names, guide scripts, or strokes you hand-write in the App stay on your device (see the
[Privacy Policy](#privacy-policy) above) and remain yours. We claim no ownership over anything you
write or draw in the App. Because this content is never transmitted to us, we have no ability to
access, back up, or recover it on your behalf — if it's lost (e.g. the app is deleted, or the
device is lost/reset without a backup), we cannot restore it.

### 5. In-app purchases

The App offers optional, consumable "seva" (dāna/offering) purchases processed by Apple through
StoreKit. These purchases:

- Are entirely voluntary and do not unlock, unlock faster, or otherwise change any feature of the
  App
- Are billed and refunded according to Apple's App Store terms and policies, not by us directly —
  refund requests should go through Apple ([reportaproblem.apple.com](https://reportaproblem.apple.com))
- Are non-transferable between Apple accounts

### 6. Advertising

The App displays interstitial and optional rewarded ads served by Google AdMob. We do not control
the content of individual ads or the sites/apps they may link to, and we are not responsible for
third-party advertising content, offers, or products. Your interactions with an ad are between you
and the advertiser or Google.
...
particular purpose, or non-infringement. We do not warrant that the App will be uninterrupted,
error-free, or that any streak, statistic, or stored record will never be lost.
...
You may stop using the App at any time by deleting it from your device. We may modify, suspend, or
discontinue the App (or any part of it) at any time, with or without notice.
